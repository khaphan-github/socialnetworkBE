...
namespace Testing {
    ...
    public class AccountRepositoryTest {
        ...
        public void GivenAnAccount_WhenInsertAccount_ThenReturnAccountInserted() {
            ...
            string password = "password-test-99";
            string passwordHash =
                bCryptService
            ...
            bool isDeleted = accountResponsitory.DeleteAccount(accountSaved.Id);
